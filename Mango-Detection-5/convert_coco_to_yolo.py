...
def main():
    ...
    print("Next: make sure your data.yaml points to train/ valid/ test/ (not train/images).")
    print("Then train: yolo segment train model=yolov8n-seg.pt data=data.yaml imgsz=640 epochs=100 batch=8")
